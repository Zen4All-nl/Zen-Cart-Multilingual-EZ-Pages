...
/* BOF Multilingual EZ Pages 2 of 3 */
$pages_order_query = "SELECT e.*, et.*
                      FROM  " . TABLE_EZPAGES . " e, " . TABLE_EZPAGES_TEXT . " et
                      WHERE ((e.status_toc = 1 AND e.toc_sort_order <> 0)
...
/* BOF Multilingual EZ Pages 3 of 3 */
require(DIR_WS_MODULES . zen_get_module_directory('require_languages.php'));
$breadcrumb->add($var_pageDetails->fields['pages_title']);
/* EOF Multilingual EZ Pages 3 of 3 */
