...
// Sets the status of a page
  ...
  if (zen_not_null($action)) {
    $heading_trailer = ($_GET['ezID'] != '' ? TEXT_INFO_PAGES_ID . (int)$_GET['ezID'] : TEXT_INFO_EZPAGES_CREATE);
  } else {
...
/* EOF Multilingual EZ Pages 4 of 12 */
        ...
        if ($page_error == false) {
          ...
          if ($action == 'insert') {
            ...
            /* BOF Multilingual EZ Pages 5 of 12 */
            ...
            /* EOF Multilingual EZ Pages 5 of 12 */
...
<?php
  if ($action == 'new') {
    ...
    $parameters = array(//'pages_title' => '', // Multilingual EZ Pages 8 of 12
